...
PrintConfigDef::PrintConfigDef()
{
    ...
    def->default_value = new ConfigOptionPercent(100);
    ...
    def = this->add("beam_size", coFloat);
    def->label = __TRANS("Beam size");
    def->category = __TRANS("Infill");
    def->tooltip = __TRANS("Size of the laser beam used for sintering.");
    def->sidetext = "mm";
    def->cli = "beam-size=f";
    def->min = 0.05;
    def->max = 0.15;
    def->default_value = new ConfigOptionFloat(0.08f);
