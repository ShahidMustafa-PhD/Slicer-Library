                                    ...
                                    map<int, Polygons> base)
{
    ...
    params.angles.push_back(45);//object_config->support_material_angle.value);
    ...
    params.interface_angle = 45;//object_config->support_material_angle.value + 90;
    params.interface_spacing =2.5;// object_config->support_material_interface_spacing.value + interface_flow.spacing();
    params.interface_density =100;
