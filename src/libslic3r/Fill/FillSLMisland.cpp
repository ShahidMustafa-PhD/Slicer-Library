...
#include <cmath>
#include <cstdio>
#include "FillSLMisland.hpp"

namespace Slic3r {

void
FillSLMisland::_fill_single_direction(ExPolygon expolygon,
    const direction_t &direction, coord_t x_shift, Polylines* out)
{
    ...
    const coord_t min_spacing   = scale_(this->hatchspacing);
    coord_t line_spacing        = min_spacing;//  min_spacing ;// this->density;  shahid
	//  force density 100%....
...
void FillSLMisland::_fill_surface_single(
