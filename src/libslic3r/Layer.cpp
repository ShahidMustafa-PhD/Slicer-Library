...
Layer::detect_surfaces_type()
{
    ...
    for (size_t region_id = 0; region_id < this->regions.size(); ++region_id) {
        ...
        if (upper_layer != NULL) {
            ...
            if (object.jconfig.interface_shells) {
    ...
    //double support_material_model_clearance = 2.3;
                (object.jconfig.support_material && object.jconfig.support_material_model_clearance == 0)
                ? stBottom
                : (stBottom | stBridge);
            ...
            const SurfaceType surface_type_bottom =
    //double support_material_model_clearance = 2.3;
                (object.jconfig.anchors > 0 && object.jconfig.support_material_model_clearance > 0)
                ? (stBottom | stBridge)
                : stBottom;
